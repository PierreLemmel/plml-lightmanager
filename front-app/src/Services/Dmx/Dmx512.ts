import { byte, clampByte, number01 } from "../../Core/Helpers/Mathf";
import { Model } from "../../Core/Models/Models";

export class Color {

    public readonly r: byte;
    public readonly g: byte;
    public readonly b: byte;


    private constructor(r: byte, g: byte, b: byte) {
        this.r = clampByte(r);
        this.g = clampByte(g);
        this.b = clampByte(b);
    }
    ...
    public static rgb(r: byte, g: byte, b: byte): Color {
...
export module Chans {
    ...
    export type ByteChannelType = typeof byteChannelTypes[number];
    ...
    export type ChannelType = ByteChannelType | ColorChannelType;

    export function isByteChannel(chan: ChannelType): chan is ByteChannelType {
        return byteChannelTypes.includes(chan as ByteChannelType);
    }
